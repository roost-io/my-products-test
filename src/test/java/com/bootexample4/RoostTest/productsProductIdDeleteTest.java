...
public class productsProductIdDeleteTest {
	...
	public void setUp() {
		...
		envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/products_productIdDeleteTest.csv",
				envVarsList);
	}

	@Test
	public void productsProductIdDelete_Test() throws JSONException {
		this.setUp();
